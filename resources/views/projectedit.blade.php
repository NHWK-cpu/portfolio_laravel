...
<body
  ...
  <div class="flex flex-row max-lg:flex-col gap-5 w-full h-[80dvh]">
    ...
    <form action="{{ url('/edit-project') }}" method="POST"
      ...
      @csrf
      <label for="image"
        class="w-full h-full max-lg:py-2 flex justify-center items-center rounded-lg text-gray-700 shadow-[3px_3px_5px_#a8a8a8,_-3px_-3px_5px_#fff] hover:cursor-pointer hover:shadow-[1px_1px_3px_#a8a8a8,_-2px_-2px_3px_#fff] active:shadow-[inset_3px_3px_5px_#a8a8a8,_inset_-3px_-3px_5px_#fff]">Screenshoot</label>
      <input type="file" name="image" id="image" hidden>

      <input type="text" name="id" value="{{ $id }}" hidden>

      <input type="text" name="name" placeholder="project name"
        class="w-full h-full max-lg:py-2 text-center focus:outline-2 focus:outline-amber-800 shadow-[inset_2px_2px_5px_#bebebe,_inset_-2px_-2px_5px_#fff] rounded-lg">
      ...
      <button type="submit"
        class="w-full h-full max-lg:py-2 rounded-lg font-semibold text-gray-700 shadow-[3px_3px_5px_#a8a8a8,_-3px_-3px_5px_#fff] hover:cursor-pointer hover:shadow-[1px_1px_3px_#a8a8a8,_-2px_-2px_3px_#fff] active:shadow-[inset_3px_3px_5px_#a8a8a8,_inset_-3px_-3px_5px_#fff]">Upload</button>
    </form>
